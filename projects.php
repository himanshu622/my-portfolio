...
<head>
  ...
  <!-- Page Title -->
  <title>Projects | Himanshu Sharma Portfolio</title>
  ...
  <meta property="og:title" content="Himanshu Sharma Portfolio">
...
<body>
      ...
      <div class="avatar__block">
        <div class="avatar__logo d-flex align-items-center">
          <div class="logo__image">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="85px" height="85px" viewBox="0 0 85 85"
          ...
          <div class="logo__caption">
            <a href="index.php"> <p>Himanshu Sharma</p></a>
          </div>
        </div>
  ...
  <div id="content" class="content">
    <div class="content__wrapper">
      ...
      <!-- About Section Start -->
      <section id="portfolio" class="inner about">
        ...
        <div class="content__block grid-block">
          ...
          <figcaption class="gallery__descr" itemprop="caption description">
             ...
             <!-- Works Gallery Single Item Start -->
              <figure class="col-12 col-md-6 gallery__item grid-item animate-card-2" itemprop="associatedMedia"
                itemscope itemtype="http://schema.org/ImageObject">
                <a href="./img/works/ideal-space.jpg"
                  data-image="./img/works/ideal-space.jpg" class="gallery__link" itemprop="contentUrl"
                  data-size="416x300">
                  <img src="./img/works/ideal-space.jpg" class="gallery__image" itemprop="thumbnail"
                    alt="Image description">
                </a>
                <figcaption class="gallery__descr opposite" itemprop="caption description">
                    <a href="https://idealspaze.com/"><h5>Go To Live</h5></a>
                  <p class="small">IdealSpaze offers innovative, modern interior design solutions, transforming spaces with style, functionality, and elegance.
                  </p>
                </figcaption>
              </figure>
              <!-- Works Gallery Single Item End -->
             ...
             <!-- Works Gallery Single Item Start -->
              <figure class="col-12 col-md-6 gallery__item grid-item animate-card-2" itemprop="associatedMedia"
                itemscope itemtype="http://schema.org/ImageObject">
                <a href="./img/works/delta.jpg"
                  data-image="./img/works/delta.jpg" class="gallery__link" itemprop="contentUrl"
                  data-size="416x300">
                  <img src="./img/works/delta.jpg" class="gallery__image" itemprop="thumbnail"
                    alt="Image description">
                </a>
                <figcaption class="gallery__descr opposite" itemprop="caption description">
                    <a href="https://deltaairservice.online/"><h5>Go To Live</h5></a>
                  <p class="small">Delta Air Service Online provides travel booking support, ticket cancellations, itinerary changes, and flight assistance services.
                  </p>
                </figcaption>
              </figure>
              <!-- Works Gallery Single Item End -->
              ...
              <!-- <figure class="col-12 col-md-6 gallery__item grid-item animate-card-2" itemprop="associatedMedia"
                itemscope itemtype="http://schema.org/ImageObject">
                <a href="./img/works/surajwood.jpg"
                  data-image="./img/works/surajwood.jpg" class="gallery__link" itemprop="contentUrl"
                  data-size="416x300">
                  <img src="./img/works/surajwood.jpg" class="gallery__image" itemprop="thumbnail"
                    alt="Image description">
                </a>
                <figcaption class="gallery__descr opposite" itemprop="caption description">
                    <a href="http://surajwood.com/"><h5>Go To Live</h5></a>
                  <p class="small">SurajWood crafts premium European‑tech acrylic panels that elevate modern interiors with durable, stylish surface solutions.
                  </p>
                </figcaption>
              </figure> -->
              <!-- Works Gallery Single Item End -->
