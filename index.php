...
<head>
  ...
  <!-- Page Title -->
  <title>Himanshu Sharma Portfolio</title>
    ...
    <div class="content__wrapper">
      ...
      <section id="home" class="main intro">
        ...
        <div id="headline" class="headline d-flex align-items-start flex-column">
          ...
          <h1 class="headline__title animate-headline">I'm Himanshu Sharma</h1>
          <h3 class="headline__title animate-headline">Frontend developer</h3>
      ...
      <section id="about" class="inner about">
        ...
        <div class="content__block section-grid-title">
          ...
          <h2 class="h2__title animate-in-up">Transforming Ideas Into Impactful Web Experiences</h2>
        </div>
      ...
      <section id="resume" class="inner resume">
          ...
          <div class="container-fluid p-0 resume-lines">
            ...
            <div class="row g-0 resume-lines__item animate-in-up">
              ...
              <div class="col-12 col-md-5">
                <h5 class="resume-lines__title animate-in-up">Bachelor of Arts</h5>
                <p class="resume-lines__source animate-in-up">
                  <a href="#0" class="text-link-bold" target="_blank">Delhi University (DU)</a>
                </p>
              </div>
              <div class="col-12 col-md-5">
            ...
            <div class="row g-0 resume-lines__item animate-in-up">
              <div class="col-12 col-md-2">
                <span class="resume-lines__date animate-in-up">2024 ( 8 Months)</span>
              </div>
              <div class="col-12 col-md-5">
                <h5 class="resume-lines__title animate-in-up">Website Designing</h5>
                <p class="resume-lines__source animate-in-up">
                  <a href="#0" class="text-link-bold" target="_blank">Vision Academy</a>
                </p>
              </div>
              <div class="col-12 col-md-5">
            ...
            <div class="row g-0 resume-lines__item animate-in-up">
              ...
              <div class="col-12 col-md-5">
                <h5 class="resume-lines__title animate-in-up">10th - 12th</h5>
                <p class="resume-lines__source animate-in-up">
                  <a href="#0" class="text-link-bold" target="_blank">Delhi United Christian Sr. Secondary School</a>
                </p>
              </div>
              <div class="col-12 col-md-5">
        ...
        <div class="content__block block-large">
          ...
          <div class="container-fluid p-0 resume-lines">
            ...
            <div class="row g-0 resume-lines__item animate-in-up">
              <div class="col-12 col-md-2">
                <span class="resume-lines__date animate-in-up">June 2024 - Present</span>
              </div>
              <div class="col-12 col-md-5">
                <h5 class="resume-lines__title animate-in-up">Website Developer</h5>
            ...
            <div class="row g-0 resume-lines__item animate-in-up">
              <div class="col-12 col-md-2">
                <span class="resume-lines__date animate-in-up">Mar 2024 - May 2024</span>
              </div>
              <div class="col-12 col-md-5">
                <h5 class="resume-lines__title animate-in-up">Digital Marketing / Photoshoot</h5>
          ...
          <div class="container-fluid p-0 contact-lines animate-in-up">
            <div class="row g-0 contact-lines__item">
              ...
              <div class="col-12 col-md-4 contact-lines__data">
                ...
                <p class="contact-lines__text animate-in-up">
                  <a class="text-link-bold" href="tel:91+7428538711">91+7428538711</a>
                </p>
              </div>
              <!-- data item -->
              <div class="col-12 col-md-4 contact-lines__data">
